...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    ...
    <ul>
        ...
        <ul>
			...
			<li><a href="<%=ResolveClientUrl("List_Top15_2019.aspx") %>">
                <h3>Best 20 Movies of 2019</h3>
			     <li><a href="<%=ResolveClientUrl("List_Top15_2018.aspx") %>">
                <h3>Best 20 Movies of 2018</h3>
             <li><a href="<%=ResolveClientUrl("List_Top15_2017.aspx") %>">
                <h3>Best 15 Movies of 2017</h3>
            </a></li>
               <li><a href="<%=ResolveClientUrl("List_Top15_2016.aspx") %>">
                <h3>Best 15 Movies of 2016</h3>
            </a></li>
