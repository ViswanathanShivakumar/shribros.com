...
<asp:Content ID="Content1" ContentPlaceHolderID="ShortReviewsHeaderContentPlaceHolder" runat="Server">
    <title>Short Reviews - B</title>
    <meta name="description" content="Short Reviews of movies starting with alphabet B" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ShortReviewsContentPlaceHolder" runat="Server">
    ...
    <a name="Blue is the Warmest Color"></a>
    <h2>Blue is the Warmest Color | 2013
    </h2>
    <p>
        “Blue is the warmest color” is a honest portrayal of coming-of-age modern love. 
        Defined by brilliant performances from its lead pair, Adèle Exarchopoulos and Léa Seydoux, the movie benefits from the epic direction of Abdel Kechiche. 
    ...
    <p>
        Woody Allen’s “Blue Jasmine” is the result of his relentless appetite for great scripts and even headed direction. 
        Cate Blanchett performance as Jasmine is mesmerizing in this darkly funny and deeply touching drama. 
        Nervous breakdowns, rugged relationships, anxieties are all composed with a comprehensive examination. 
        Marginally unhinged, while witty and cautionary, “Blue Jasmine” is one of Woody Allen’s best recent efforts.
    </p>
       <a name="Butler, The"></a>
    <h2>The Butler | 2013
    </h2>
    <p>
       Lee Daniels’ “The Butler” follows Cecil Gaines (Forest Whitaker), an African American who serves at least eight presidents, as a butler in the White House. The film is melodramatic in comparison with Daniels’ previous superior work “Precious", but strongly holds ground with its story telling. With wonderful cast supporting him, Daniels smoothly drives the movie, although lethargically. “The Butler” is not as gritty as last year’s “Twelve Years a slave”, but lives well in its own world.
        ...
        <a name="Bangalore Days"></a>
    <h2>Bangalore Days| 2014
    </h2>
    <p>
